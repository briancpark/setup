sudo apt install python3 default-jre gcc valgrind neofetch htop vim git texlive-full pip3-python libgl1-mesa-glx libegl1-mesa libxrandr2 libxrandr2 libxss1 libxcursor1 libxcomposite1 libasound2 libxi6 libxtst6 texlive-fonts-extra -y
